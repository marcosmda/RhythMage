...
class SmileToUnlockController: BaseViewController<SmileToUnlockView>, ARSCNViewDelegate {
    ...
    typealias Factory = SongLibrarySceneFactory & SmileToResumeFactory & SettingsSceneFactory & TestViewFactory
    let factory: Factory
...
//        let navController = UINavigationController(rootViewController: factory.createTestViewScene())
        navigationController?.pushViewController(factory.createTestViewScene(), animated: true)
    }
