...
struct Video {
    ...
    static func setOnboarding() -> Video {
        return Video(title: "rhtyhMage", subtitles: [
            ...
            8.30 : "He liked the songs so much that he got distracted and never wrote down his new spells.",
            13.0 : "One day, he went to do a new spell that went terribly wrong, and all the spells he remembered came out of his head, floating in different rhythms!",
